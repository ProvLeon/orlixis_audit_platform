                      ...
                      <div className="flex items-center space-x-4 min-w-0">
                        ...
                        <div className="min-w-0">
                          ...
                          <div className="flex items-center flex-wrap gap-2 mt-1">
                            ...
                            <Badge variant={project.issues > 0 ? getSeverityVariant("high") : "info"} size="sm"
                              translucent
                              blurred
                            >
          ...
          <Card>
            <CardHeader>
              <div className="flex items-center justify-between">
                ...
                <Badge variant="high" size="sm" className="bg-orange-900/10 text-orange-600 border-orange-200" blurred translucent>
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center justify-between mt-2">
                          <Badge variant={getSeverityVariant(alert.severity)} size="sm" blurred translucent>
                            {alert.severity}
                          </Badge>
