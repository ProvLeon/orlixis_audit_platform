...
export default function NotFoundClient({ recent: initialRecent, currentUrl: initialUrl, referrer: initialReferrer, timestamp: initialTimestamp }: NotFoundClientProps) {
