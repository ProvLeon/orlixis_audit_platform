        ...
        <View style={styles.row}>
          <View style={styles.column}>
            <Text style={styles.text}>
              <Text style={styles.bold}>Project Language: </Text>
              {project.language || 'N/A'}
            </Text>
            <Text style={styles.text}>
              <Text style={styles.bold}>Framework: </Text>
        ...
        <View style={styles.section}>
          {vulnerabilities.slice(0, 10).map((vuln, index) => (
            <View key={index} style={styles.vulnerabilityItem}>
              ...
              {vuln.file && (
                <Text style={styles.text}>
                  <Text style={styles.bold}>File: </Text>
                  {vuln.file}
              ...
              {vuln.cwe && (
                <Text style={styles.text}>
                  <Text style={styles.bold}>CWE: </Text>
                  {vuln.cwe}
                </Text>
              )}
            </View>
...
export class ReactPDFGenerator {
  ...
  public async healthCheck(): Promise<{ success: boolean; message: string }> {
    try {
      ...
      return {
        success: true,
        message: `React PDF generation is working. Generated ${pdfBuffer.length} bytes.`
      }
    } catch (error: any) {
      return {
        success: false,
